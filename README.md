...
|  3. |  [**Movie-Recommendation-System**]([https://github.com/Sghosh1999/AlphaAI-Minor-Project-6th-Sem](https://github.com/Sghosh1999/Movie-Recommendation-System))       |    This is a Streamlit based Movie Recommendation System build on Content Based Filtering & Demographic Filtering (Plot Description , Popularity/ Genres/ Cast/ Director). Used TF-IDF Vectorizer     . | Recommendation System |  
